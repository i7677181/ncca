...
/// @class Octree
/// @brief I have used this class for finding the neighbours of a boid in my swarming system. I have made small modification
/// from the original class such as removing methods which were not necesarrily needed for the calculations.
//----------------------------------------------------------------------------------------------------------------------
#ifndef OCTREE_H
#define OCTREE_H
